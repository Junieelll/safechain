...
(function injectCSS() {
  ...
  style.textContent = [
    ...
    /* +N more overlay */
    ".sc-media-tile__overflow{position:absolute;inset:0;background:rgba(0,0,0,.65);display:flex;align-items:center;justify-content:center;color:#fff;font-size:26px;font-weight:700;letter-spacing:-.5px;pointer-events:none;}",
...
function _scInjectLightbox() {
  ...
  lb.innerHTML =
    ...
    '<button class="sc-lb-btn" onclick="scLightboxZoom(-0.25)" title="Zoom out (-)">&#8722;</button>' +
