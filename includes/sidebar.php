    ...
    <nav class="h-[calc(100%-86px)] flex flex-col justify-between">
        <ul id="primaryNav"
            ...
            <?php foreach ($navStructure['groups'] as $group): ?>
                ...
                <li class="relative nav-group text-sm">
                    ...
                    <ul class="nav-group-items list-none ml-0 overflow-hidden transition-all duration-300"
                        style="max-height: 0;">
        ...
        <ul class="list-none flex gap-1.5 px-[15px] flex-col relative pb-5">
            <li class="relative nav-item text-sm mt-2">
                ...
                <span
                    class="nav-tooltip py-2 px-3.5 rounded-xl whitespace-nowrap bg-white shadow-[0_4px_15px_rgba(0,0,0,0.2)] font-medium text-sm text-[#01AF78] z-[9999]">Dark
                    Mode</span>
            </li>
            <li class="relative">
                <button id="userProfileBtn"
                    ...
                    <div id="userInfo" class="flex flex-col transition-opacity duration-300 text-left">
                        ...
                        <span
                            class="text-xs bg-white text-emerald-400 w-max py-1 px-3 rounded-full font-medium"><?php echo htmlspecialchars($username); ?></span>
                    </div>
                </button>
