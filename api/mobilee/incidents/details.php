            ...
            <div id="responderBanner" class="hidden mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
              ...
              <div class="flex items-center gap-3">
                ...
                <button id="trackResponderBtn"
                  ...
                  class="hidden flex items-center gap-1.5 px-3 py-1.5 bg-blue-500 hover:bg-blue-600 text-white text-xs font-semibold rounded-lg transition-all hover:-translate-y-0.5 hover:shadow-md">
