...
<body class="min-h-screen flex transition-all duration-300 dark:bg-neutral-900">
  ...
  <main id="mainContent" class="transition-all duration-500 ease-in-out ml-[302px] flex-1 p-8">
    <div class="header flex items-center justify-between mb-5 animate-target">
      <div class="title">
        <h4 class="text-bs font-semibold text-[#4b4b4b] dark:text-neutral-400">
          Incident Log
        </h4>
    ...
    <div class="widget grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-9 mb-7 animate-target">
      <div
        ...
        <div
          ...
          <i class="uil uil-exclamation-circle text-red-400 dark:text-red-300 text-xl md:text-2xl"></i>
        </div>
        <p id="incidentCount" class="count text-xl md:text-2xl font-semibold text-neutral-600 dark:text-neutral-400">
          <i class="uil uil-ellipsis-h"></i>
        </p>
        <p class="title text-xs md:text-sm text-neutral-600 font-medium dark:text-neutral-400">
          Total Incidents
        </p>
        <p class="subtitle text-[10px] md:text-xs flex items-center text-red-400">
      ...
      <div
        ...
        <div
          ...
          <i class="uil uil-bolt-alt text-[#3B82F6] dark:text-blue-300 text-xl md:text-2xl"></i>
        </div>
        <p id="activeCount" class="count text-xl md:text-2xl font-semibold text-neutral-600 dark:text-neutral-400">
          <i class="uil uil-ellipsis-h"></i>
        </p>
        <p class="title text-xs md:text-sm text-neutral-600 font-medium dark:text-neutral-400">
          Active Incidents
        </p>
        <p class="subtitle text-[10px] md:text-xs flex items-center text-[#3B82F6]">
      ...
      <div
        ...
        <div
          ...
          <i class="uil uil-check-circle text-emerald-400 dark:text-emerald-300 text-xl md:text-2xl"></i>
        </div>
        <p id="resolvedCount" class="count text-xl md:text-2xl font-semibold text-neutral-600 dark:text-neutral-400">
          <i class="uil uil-ellipsis-h"></i>
        </p>
        <p class="title text-xs md:text-sm text-neutral-600 font-medium dark:text-neutral-400">
          Resolved
        </p>
        <p class="subtitle text-[10px] md:text-xs flex items-center text-emerald-400">
      ...
      <div
        ...
        <div
          ...
          <i class="uil uil-clock text-[#ECA613] dark:text-yellow-300 text-xl md:text-2xl"></i>
        </div>
        <p id="pendingCount" class="count text-xl md:text-2xl font-semibold text-neutral-600 dark:text-neutral-400">
          <i class="uil uil-ellipsis-h"></i>
        </p>
        <p class="title text-xs md:text-sm text-neutral-600 font-medium dark:text-neutral-400">
          Pending
        </p>
        <p class="subtitle text-[10px] md:text-xs flex items-center text-[#ECA613]">
          Awaiting Response
        </p>
      </div>
    </div>
    ...
    <section class="incidents animate-target">
      ...
      <div
        ...
        <div class="search flex flex-col gap-1 w-full md:max-w-[400px]">
          <label for="search" class="text-xs text-gray-700 dark:text-neutral-400">Search</label>
          <div class="search-input relative w-full">
            <i class="uil uil-search absolute top-1/2 -translate-y-1/2 left-2 text-xl dark:text-neutral-400"></i>
            <input type="text" name="search" id="search" autocomplete="off" placeholder="Search incidents..."
        ...
        <div class="dropdown flex flex-col md:flex-row gap-3 w-full">
          ...
          <div class="types flex flex-col gap-1 w-full">
            <label for="types" class="text-xs text-gray-700 dark:text-neutral-400">Type</label>
            <div class="relative max-h-[46px]">
              <button id="typeDropdownButton"
                ...
                <span id="typeSelectedText" class="text-gray-700 text-xs dark:text-white/85">All Types</span>
                <i id="typeDropdownIcon"
          ...
          <div class="status flex flex-col gap-1 w-full">
            <label for="status" class="text-xs text-gray-700 dark:text-white/85">Status</label>
            <div class="relative max-h-[46px]">
              <button id="statusDropdownButton"
                ...
                <span id="statusSelectedText" class="text-gray-700 text-xs dark:text-white/85">All Status</span>
                <i id="statusDropdownIcon"
                  class="uil uil-angle-down text-xl text-gray-400 transition-transform duration-200"></i>
              </button>
          ...
          <div class="date-range flex flex-col gap-1 w-full">
            <label for="date-range" class="text-xs text-gray-700 dark:text-white/85">Date Range</label>
            <div class="relative max-h-[46px]">
              <button id="dateButton"
                ...
                <span id="dateText" class="text-xs text-gray-700 dark:text-white/85">Date Range</span>
                <i id="dateIcon" class="uil uil-angle-down text-lg text-gray-400 transition-transform duration-200"></i>
              </button>
              ...
              <div id="dateMenu"
                ...
                <!-- Custom Date Inputs -->
                <div id="customDates" class="hidden border-t border-neutral-500 pt-3">
                  <div class="grid grid-cols-2 gap-2 mb-3">
                    <div>
                      <label class="block text-xs text-neutral-600 dark:text-neutral-400 mb-1">From</label>
                    ...
                    <div>
                      <label class="block text-xs text-neutral-600 dark:text-neutral-400 mb-1">To</label>
          ...
          <div class="clear-filter-btn flex flex-col justify-end w-full md:w-auto">
      ...
      <div
        ...
        <div class="overflow-x-auto -mx-3 md:mx-0">
          ...
          <table class="w-full min-w-[800px]">
            <thead class="bg-[#F1F5F9] dark:bg-neutral-700">
              <tr>
                <th class="px-3 md:px-4 py-3 md:py-4 w-10">
                  <input type="checkbox" id="selectAllIncidents"
        ...
        <!-- Pagination -->
        <div class="inline-flex items-center justify-center w-full gap-2 mt-4">
          <button id="prevBtn"
          ...
          <div class="bg-[#F1F5F9] dark:bg-neutral-700 rounded-full p-1 inline-flex items-center gap-2"></div>
          <button id="nextBtn"
            class="w-9 h-9 dark:bg-neutral-700 flex items-center justify-center rounded-full bg-[#F1F5F9] text-gray-600 hover:bg-emerald-50 hover:text-emerald-500 transition-colors shadow-sm">
    ...
    <div
      ...
      <span class="text-white text-sm font-medium"><span id="incidentSelectedCount">0</span> incident(s) selected</span>
      <button
    ...
    <div id="incidentArchiveModal"
      ...
      <div class="px-6 py-4">
        <p class="text-xs text-gray-600 text-center leading-relaxed">
          ...
          <span id="incidentArchive" class="font-semibold" style="color: #27c291">EMG-2024-1001</span>
      ...
      <div class="flex items-center gap-3 p-6 pt-4">
        ...
        <button onclick="confirmArchiveIncident()"
          ...
          style="background-color: #27c291" onmouseover="this.style.backgroundColor='#22A87B'"
