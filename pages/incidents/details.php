        ...
        <div class="lg:col-span-2 space-y-7">
          ...
          <div class="bg-white dark:bg-neutral-800 rounded-3xl p-7">
            <div
              ...
              <span
                ...
                id="statusBadge">
                <span
                  class="w-2 h-2 rounded-full bg-gray-600 status-dot"></span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
              <div class="flex flex-col gap-1.5">
                <span
                  class="text-xs text-gray-500 dark:text-neutral-400 font-semibold uppercase tracking-wider">Incident ID</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-neutral-300"><i class="uil uil-ellipsis-h"></i></span>
              </div>
              <div class="flex flex-col gap-1.5">
                <span
                  class="text-xs text-gray-500 dark:text-neutral-400 font-semibold uppercase tracking-wider">Date Reported</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-neutral-300"><i class="uil uil-ellipsis-h"></i></span>
              </div>
              <div class="flex flex-col gap-1.5">
                <span
                  class="text-xs text-gray-500 dark:text-neutral-400 font-semibold uppercase tracking-wider">Time Reported</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-neutral-300"><i class="uil uil-ellipsis-h"></i></span>
              </div>
            </div>
          ...
          <div class="bg-white dark:bg-neutral-800 rounded-3xl p-7">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-4">
              ...
              <div class="flex flex-col gap-1.5">
                ...
                <span class="text-sm font-semibold text-gray-900 dark:text-neutral-300" id="coordinates"><i class="uil uil-ellipsis-h"></i></span>
              </div>
            </div>
          ...
          <div class="bg-white dark:bg-neutral-800 rounded-3xl p-7">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div class="flex flex-col gap-1.5">
                <span
                  class="text-xs text-gray-500 dark:text-neutral-400 font-semibold uppercase tracking-wider">User ID</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-neutral-300"><i class="uil uil-ellipsis-h"></i></span>
              </div>
              <div class="flex flex-col gap-1.5">
                <span
                  class="text-xs text-gray-500 dark:text-neutral-400 font-semibold uppercase tracking-wider">Contact Number</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-neutral-300"><i class="uil uil-ellipsis-h"></i></span>
              </div>
              <div class="flex flex-col gap-1.5">
                <span
              ...
              <div class="flex flex-col gap-1.5">
                <span
                  class="text-xs text-gray-500 dark:text-neutral-400 font-semibold uppercase tracking-wider">Resident Since</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-neutral-300"><i class="uil uil-ellipsis-h"></i></span>
              </div>
              <!--<div class="flex flex-col gap-1.5">
                  <span
        ...
        <div class="space-y-7">
          ...
          <div class="bg-white dark:bg-neutral-800 rounded-3xl p-7">
            ...
            <div class="grid grid-cols-2 gap-5">
              <div class="flex flex-col gap-1.5">
                <span
                  class="text-xs text-neutral-500 dark:text-neutral-400 font-semibold uppercase tracking-wider">Emergency Hotline</span>
                <span class="text-sm font-semibold text-red-600 dark:text-neutral-200">122</span>
              </div>
              <div class="flex flex-col gap-1.5">
                <span
                  class="text-xs text-gray-500 dark:text-neutral-400 font-semibold uppercase tracking-wider">Fire Department</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-neutral-200">(02) 8426-0219</span>
              </div>
              <div class="flex flex-col gap-1.5">
                <span
                  class="text-xs text-gray-500 dark:text-neutral-400 font-semibold uppercase tracking-wider">Police (PNP)</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-neutral-200">(02) 8722-0650</span>
              </div>
              <div class="flex flex-col gap-1.5">
                <span
                  class="text-xs text-gray-500 dark:text-neutral-400 font-semibold uppercase tracking-wider">Barangay Hall</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-neutral-200">+63 917 555 1234</span>
              </div>
              <div class="flex flex-col gap-1.5">
                <span
                  class="text-xs text-gray-500 dark:text-neutral-400 font-semibold uppercase tracking-wider">Red Cross</span>
